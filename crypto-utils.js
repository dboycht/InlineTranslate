/* 行内翻译 · 加密工具
   md5：百度翻译开放平台签名（v2 标准，appid+q+salt+密钥），Paul Johnston 公有领域实现
   sha256Hex：有道智云签名（signType=v3，sha256(appKey+input+salt+curtime+密钥)），基于 Web Crypto */
'use strict';
...
function md5(string) {
  ...
  string = unescape(encodeURIComponent(string)); // 转 UTF-8
